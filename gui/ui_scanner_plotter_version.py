...
################################################################################
## Form generated from reading UI file 'ui_scanner_plotter_version.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_6.setGeometry(QRect(0, 0, 1451, 661))
        ...
        self.main_layout.addLayout(self.settings_layout, 4, 2, 1, 1)

        self.line_9 = QFrame(self.gridLayoutWidget_6)
        self.line_9.setObjectName(u"line_9")
        self.line_9.setFrameShape(QFrame.Shape.HLine)
        self.line_9.setFrameShadow(QFrame.Shadow.Sunken)

        self.main_layout.addWidget(self.line_9, 2, 5, 1, 1)
        ...
        self.main_layout.addLayout(self.z_move_layout, 1, 2, 1, 1)

        self.graphicsView = QGraphicsView(self.gridLayoutWidget_6)
        self.graphicsView.setObjectName(u"graphicsView")

        self.main_layout.addWidget(self.graphicsView, 1, 5, 1, 1)
        ...
        self.main_layout.addWidget(self.line_4, 4, 3, 1, 1)
        ...
        self.main_layout.addWidget(self.line, 2, 0, 1, 1)
        ...
        self.main_layout.addWidget(self.line_5, 1, 3, 1, 1)

        self.config_layout = QFormLayout()
        self.config_layout.setObjectName(u"config_layout")

        self.main_layout.addLayout(self.config_layout, 4, 4, 1, 1)
        ...
        self.main_layout.addWidget(self.line_6, 2, 2, 1, 1)
        ...
        self.y_axis_slider.setOrientation(Qt.Orientation.Vertical)
        self.y_axis_slider.setTickPosition(QSlider.TickPosition.TicksAbove)
        ...
        self.x_axis_slider.setOrientation(Qt.Orientation.Horizontal)
        self.x_axis_slider.setInvertedAppearance(False)
        self.x_axis_slider.setTickPosition(QSlider.TickPosition.TicksAbove)
        ...
        self.main_layout.addLayout(self.diplay_layout, 4, 0, 1, 1)
        ...
        self.main_layout.addWidget(self.line_8, 2, 4, 1, 1)
        ...
        self.main_layout.addWidget(self.line_2, 1, 1, 1, 1)
        ...
        self.main_layout.addLayout(self.scan_layout, 1, 4, 1, 1)
        ...
        self.main_layout.addLayout(self.xy_move_layout, 1, 0, 1, 1)

        self.frame = QFrame(self.gridLayoutWidget_6)
        self.frame.setObjectName(u"frame")
        self.frame.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame.setFrameShadow(QFrame.Shadow.Raised)
        self.layoutWidget = QWidget(self.frame)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(1, -1, 371, 321))
        self.plot_config_wid = QFormLayout(self.layoutWidget)
        self.plot_config_wid.setObjectName(u"plot_config_wid")
        self.plot_config_wid.setContentsMargins(0, 0, 0, 0)

        self.main_layout.addWidget(self.frame, 4, 5, 1, 1)

        MainWindow.setCentralWidget(self.central_widget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1729, 25))
